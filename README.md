...
It uses a pre-compiled version of SQLite taken from Steve Sanderson's original demo project (which means I dd not need to worry about compiling that myself)
